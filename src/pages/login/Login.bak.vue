  ...
  <div class="login">
    ...
    <section id="normalLogin" class="login-section">
      ...
      <form class="form" id="CommonLogin" action="/login/post" method="post" onsubmit="return false;">
        ...
        <a href="javascript:" class="login-btn disabled">
          登录
        </a>
        <div class="regist-wrap">
          <a href="/register/mapp">注册新用户</a>
          <span>|</span>
          <a href="/forget/getPassword">找回密码</a>
        </div>
      </form>
    </section>
  </div>
...
export default {
  ...
  watch: {
    username: function (newVal, oldVal) {
      console.log(`usename change:${oldVal}=>${newVal}`)
    },
    password: function (newVal, oldVal) {
      console.log(`password change:${oldVal}=>${newVal}`)
    }
  },
  computed: {
    isShowUserNameDel () {
